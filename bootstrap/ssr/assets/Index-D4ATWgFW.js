...
import { W as WhatsAppIcon, u as useGsapContext, s as serviceCatalog, r as reassuranceItems, F as FrontNavbar, a as FrontScrollRefresh, b as FrontFooter } from "./front-B1zqx60K.js";
...
function ServicesLeadCtaSection() {
  return /* @__PURE__ */ jsxs("section", { style: { background: "var(--ink)", padding: "clamp(80px,10vh,120px) 0", textAlign: "center", position: "relative", overflow: "hidden" }, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "qw-container", style: { position: "relative", zIndex: 1 }, children: /* @__PURE__ */ jsxs("div", { style: { maxWidth: 640, margin: "0 auto" }, children: [
      /* @__PURE__ */ jsx("span", { style: { fontFamily: "'Inter',sans-serif", fontSize: ".68rem", fontWeight: 600, color: "var(--brass)", letterSpacing: ".22em", textTransform: "uppercase", display: "block", marginBottom: 18 }, children: "Start Your Project" }),
      ...
      /* @__PURE__ */ jsx("p", { style: { fontFamily: "'Inter',sans-serif", fontSize: ".92rem", color: "rgba(246,242,236,.4)", marginBottom: 36, lineHeight: 1.7 }, children: "Free site assessment. Detailed written quote. No obligation." }),
...
function ServicesIndex() {
  return /* @__PURE__ */ jsxs("div", { className: "qw-front", children: [
    /* @__PURE__ */ jsxs(Head, { title: "Services — Quality Work Interior", children: [
